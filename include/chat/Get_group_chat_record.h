#ifndef GET_GROUP_CHAT_RECORD_H
#define GET_GROUP_CHAT_RECORD_H
#include "chat/Module.h"
#include "redis/Redis.h"
#include "protobuf/Coder.h"

// 获取群聊天记录模块类
class Get_group_chat_record : public Module
{
public:
	Get_group_chat_record():_redis("127.0.0.1", 6379)
	{
	}
